...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { password: @seller.password, username: @seller.username } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { password: @seller.password, username: @seller.username } }
