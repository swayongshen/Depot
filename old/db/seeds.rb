...
#---
# encoding: utf-8
Seller.create!(username: 'bla', password:'bla')
Product.delete_all
Product.create!(name: 'Rails, Angular, Postgres, and Bootstrap',
  description:
    %{<p>
  ...
  seller_id: 1)
# . . .
Product.create!(name: 'Seven Mobile Apps in Seven Weeks',
  description:
    %{<p>
...
Product.create!(name: 'Ruby Performance Optimization',
  description:
    %{<p>
